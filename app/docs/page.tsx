...
export default function Docs() {
  ...
  const codeExample = `// Oxidiko Web Vault JavaScript SDK (Secure postMessage flow)
class OxidikoAuth {
    constructor(options = {}) {
        this.baseUrl = options.baseUrl || 'https://v0-oxidiko.vercel.app'
...
// Request these fields from the user's vault
const requestedFields = ['name', 'email'];

// Start authentication
const result = await oxidiko.authenticate(requestedFields);
